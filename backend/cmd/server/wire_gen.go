...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	providerHallHandler := handler.NewProviderHallHandler(channelMonitorService, settingService, channelMonitorV2Service)
	...
	apiKeyGenerator := service.ProvideChannelOnboardingAPIKeyGenerator(apiKeyService)
	schedulerAccountCache := service.ProvideChannelOnboardingSchedulerCache(schedulerSnapshotService)
	channelOnboardingService := service.NewChannelOnboardingService(client, adminService, groupRepository, adminAccountRepository, apiKeyRepository, channelMonitorService, userRepository, apiKeyGenerator, apiKeyAuthCacheInvalidator, schedulerAccountCache)
	channelOnboardingHandler := admin.NewChannelOnboardingHandler(channelOnboardingService)
