...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	channelOnboardingService := service.NewChannelOnboardingService(client, adminService, groupRepository, adminAccountRepository, apiKeyService, channelMonitorService, settingRepository, schedulerAccountCache)
