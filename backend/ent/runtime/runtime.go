...
func init() {
	...
	channelmonitorDescPublicVisible := channelmonitorFields[18].Descriptor()
	...
	channelmonitorDescPublicNote := channelmonitorFields[19].Descriptor()
	...
	channelmonitorDescReportURL := channelmonitorFields[20].Descriptor()
