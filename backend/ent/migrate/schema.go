...
var (
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{ChannelMonitorHistoriesColumns[12], ChannelMonitorHistoriesColumns[1], ChannelMonitorHistoriesColumns[7]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "numeric"}},
