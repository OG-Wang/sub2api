    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          description: 'Choose V1 active probes, V2 passive usage monitoring, or run both. When disabled, both background jobs stop and the user entry is hidden.',
          ...
          mode: 'Monitor mode',
          modeHint: 'Default is V1 (active probes). Switch to V2 for passive aggregation; the Provider Hall needs both, so pick Hybrid.',
          modeV2: 'V2 passive monitoring',
          modeV1: 'V1 active probes',
          modeHybrid: 'V1 + V2 hybrid',
          ...
          modeHybridHint: 'Runs active probes and passive aggregation together. Required by the Provider Hall page. Note both background jobs add up — watch load during off-peak first.',
