export default {
    ...
    channelMonitor: {
      ...
      providerHall: {
        section: 'Provider Hall (optional)',
        sectionHint: 'Controls whether this monitor appears on the user-facing Provider Hall page, and which real group it links to.',
        publicVisible: 'Show on Provider Hall',
        ...
        publicNoteHint: 'Rendered under the group name on the hall. Up to 200 characters.',
